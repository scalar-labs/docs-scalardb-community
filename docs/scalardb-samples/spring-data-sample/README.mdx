...
This tutorial describes how to create a sample Spring Boot application for the same use case as [ScalarDB Sample](../scalardb-sample/README.mdx) but by using Spring Data JDBC for ScalarDB.
