...
This tutorial describes how to create a Spring Boot sample application for microservice transactions for the same use case as [ScalarDB Sample](../scalardb-sample/README.mdx) but by using Two-phase Commit Transactions in ScalarDB.
...
Please see [this document](../../two-phase-commit-transactions.mdx#handle-exceptions) for the details of how to handle exceptions in ScalarDB.
...
Please see [this document](../../two-phase-commit-transactions.mdx#request-routing-in-two-phase-commit-transactions) for the details of Request Routing in Two-phase Commit Transactions.
...
[The configuration for the Customer Service](https://github.com/scalar-labs/scalardb-samples/blob/main/spring-data-microservice-transaction-sample/customer-service/src/main/resources/application.properties) is as follows:
...
For details, please see [Configuration - Multi-storage Transactions](../../multi-storage-transactions.mdx#configuration).

[The configuration for the Order Service](https://github.com/scalar-labs/scalardb-samples/blob/main/spring-data-microservice-transaction-sample/order-service/src/main/resources/application.properties) is as follows:
...
For details about how to handle exceptions in ScalarDB, see [Handle exceptions](../../two-phase-commit-transactions.mdx#handle-exceptions).
